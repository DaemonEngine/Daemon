...
static bool CheckStage( shaderStage_t *pStage )
{
	struct stageCheck_t {
		bool expected;
		bool check;
	...
	if ( stageTypeCheck.count( pStage->type ) )
	{
		stageCheck_t stageCheck = stageTypeCheck.at( pStage->type );
