...
void RB_RenderPostDepthLightTile()
{
	...
	w = (windowConfig.vidWidth + TILE_SIZE_STEP1 - 1) >> TILE_SHIFT_STEP1;
	h = (windowConfig.vidHeight + TILE_SIZE_STEP1 - 1) >> TILE_SHIFT_STEP1;
	GL_Viewport( 0, 0, w, h );
	GL_Scissor( 0, 0, w, h );
	...
	w = (windowConfig.vidWidth + TILE_SIZE - 1) >> TILE_SHIFT;
	h = (windowConfig.vidHeight + TILE_SIZE - 1) >> TILE_SHIFT;
	GL_Viewport( 0, 0, w, h );
	GL_Scissor( 0, 0, w, h );
