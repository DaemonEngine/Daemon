...
void VulkanLoadDeviceFunctions( VkDevice device, VkInstance instance ) {
	vkAllocationFunction = ( PFN_vkAllocationFunction ) vkGetDeviceProcAddr( device, "vkAllocationFunction" );

	vkFreeFunction = ( PFN_vkFreeFunction ) vkGetDeviceProcAddr( device, "vkFreeFunction" );

	vkInternalAllocationNotification = ( PFN_vkInternalAllocationNotification ) vkGetDeviceProcAddr( device, "vkInternalAllocationNotification" );

	vkInternalFreeNotification = ( PFN_vkInternalFreeNotification ) vkGetDeviceProcAddr( device, "vkInternalFreeNotification" );

	vkReallocationFunction = ( PFN_vkReallocationFunction ) vkGetDeviceProcAddr( device, "vkReallocationFunction" );

	vkVoidFunction = ( PFN_vkVoidFunction ) vkGetDeviceProcAddr( device, "vkVoidFunction" );

	vkDestroyInstance = ( PFN_vkDestroyInstance ) vkGetDeviceProcAddr( device, "vkDestroyInstance" );
	...
	vkCreateDisplayPlaneSurfaceKHR = ( PFN_vkCreateDisplayPlaneSurfaceKHR ) vkGetDeviceProcAddr( device, "vkCreateDisplayPlaneSurfaceKHR" );
	...
	vkDebugReportCallbackEXT = ( PFN_vkDebugReportCallbackEXT ) vkGetDeviceProcAddr( device, "vkDebugReportCallbackEXT" );

	vkCreateDebugReportCallbackEXT = ( PFN_vkCreateDebugReportCallbackEXT ) vkGetDeviceProcAddr( device, "vkCreateDebugReportCallbackEXT" );

	vkDestroyDebugReportCallbackEXT = ( PFN_vkDestroyDebugReportCallbackEXT ) vkGetDeviceProcAddr( device, "vkDestroyDebugReportCallbackEXT" );

	vkDebugReportMessageEXT = ( PFN_vkDebugReportMessageEXT ) vkGetDeviceProcAddr( device, "vkDebugReportMessageEXT" );
	...
	vkDebugUtilsMessengerCallbackEXT = ( PFN_vkDebugUtilsMessengerCallbackEXT ) vkGetDeviceProcAddr( device, "vkDebugUtilsMessengerCallbackEXT" );
	...
	vkCreateDebugUtilsMessengerEXT = ( PFN_vkCreateDebugUtilsMessengerEXT ) vkGetDeviceProcAddr( device, "vkCreateDebugUtilsMessengerEXT" );

	vkDestroyDebugUtilsMessengerEXT = ( PFN_vkDestroyDebugUtilsMessengerEXT ) vkGetDeviceProcAddr( device, "vkDestroyDebugUtilsMessengerEXT" );

	vkSubmitDebugUtilsMessageEXT = ( PFN_vkSubmitDebugUtilsMessageEXT ) vkGetDeviceProcAddr( device, "vkSubmitDebugUtilsMessageEXT" );
	...
	vkDeviceMemoryReportCallbackEXT = ( PFN_vkDeviceMemoryReportCallbackEXT ) vkGetDeviceProcAddr( device, "vkDeviceMemoryReportCallbackEXT" );
	...
	vkGetInstanceProcAddrLUNARG = ( PFN_vkGetInstanceProcAddrLUNARG ) vkGetDeviceProcAddr( device, "vkGetInstanceProcAddrLUNARG" );
